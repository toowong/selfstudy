<div class="customers index">
	...
	<div class="well">
		<?php
			/** 全文検索 */
			echo $this->Form->create('Customer', array('url' => array('controller' => 'customers', 'action' => 'index','l' => '7','r' => '5')));
		...
		<?php
			/** 顧客検索 */
			echo $this->Form->create('Customer', array('class' => 'form-horizontal', 'url' => array('controller' => 'customers', 'action' => 'index','l' => '7','r' => '5')));
		?>
		<table>
			<tr>
