...
<div class="customers index">
	...
	<div class="well">
		<?php
			/** 全文検索 */
			echo $this->Form->create('Customer', array('url' => array('controller' => 'customers', 'action' => 'index','l' => '8','r' => '1')));
		...
		<?php
			/** 顧客検索 */
			echo $this->Form->create('Customer', array('class' => 'form-horizontal', 'url' => array('controller' => 'customers', 'action' => 'index','l' => '8','r' => '1')));
		?>
		<table>
			<tr>
